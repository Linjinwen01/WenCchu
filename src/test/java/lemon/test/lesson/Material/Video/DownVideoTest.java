...
public class DownVideoTest extends BaseTest {
    @Test
    public void DownLoad_test() throws InterruptedException {
        ...
        login.ClickButton();
        Thread.sleep(3000);
        DownVideo downVideo = new DownVideo(driver);
        downVideo.ClickLesson();
        Thread.sleep(3000);
        downVideo.ClickMaterial();
        Thread.sleep(3000);
        downVideo.ClickVideo();
        Thread.sleep(3000);
        downVideo.ClickDownLoadButton();
    }
}
