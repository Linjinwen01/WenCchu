...
public class DeleteVideoGroupTest extends BaseTest {
    ...
    public void DeleteGroup_test() throws InterruptedException{
        ...
        Thread.sleep(3000);
        login.ClickButton();
        DeleteVideoGroup deleteVideoGroup = new DeleteVideoGroup(driver);
        deleteVideoGroup.ClickLesson();
        Thread.sleep(3000);
        deleteVideoGroup.ClickMaterial();
        Thread.sleep(5000);
        deleteVideoGroup.ClickSelect();
        Thread.sleep(3000);
        deleteVideoGroup.ClickVideo();
        Thread.sleep(3000);
        ...
        Thread.sleep(3000);
        deleteVideoGroup.ClickDelete();
        Thread.sleep(3000);
        deleteVideoGroup.ClickGroupName();
        Thread.sleep(3000);
        deleteVideoGroup.InputGroupName("测试分组");
        Thread.sleep(3000);
        deleteVideoGroup.EnterDelete();
