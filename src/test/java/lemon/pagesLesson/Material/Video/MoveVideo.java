package lemon.pagesLesson.Material.Video;

import lemon.common.BasePage;
import org.openqa.selenium.By;
import org.openqa.selenium.WebDriver;

public class MoveVideo extends BasePage {
    ...
    private By ClickVideo = By.xpath("//div[@role='tablist']//div[4]");
    ...
    private By ClickSelectGroup = By.xpath("//div[@x-placement='bottom-start']//div//ul//li[3]");

    private By ClickEnter = By.xpath("//*[@id=\"app\"]/div/div[2]/section/div/div[2]/div[3]/div/div/div[3]/span/button[2]/span");

    public MoveVideo(WebDriver driver) {
        super(driver);
    }
