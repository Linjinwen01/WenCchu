...
public class StaffSet extends BasePage {
    ...
    private By ClickNew = By.xpath("//div[@class='body']//form//button");
    ...
    private By Enter = By.xpath("//*[@id=\"app\"]/div/div[2]/section/div/div[4]/div/div/div[3]/span/button[2]/span");

    public StaffSet(WebDriver driver) {
        super(driver);
    }
